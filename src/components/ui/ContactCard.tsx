...
export function ContactCard({ card }: ContactCardProps) {
  ...
  return (
    <div 
      className="px-4 py-6 rounded-3xl shadow-sm backdrop-blur-md max-w-sm mx-auto transform-gpu dark:shadow-lg dark:shadow-gray-900/30"
      style={{ 
    ...
    >
      ...
      <div className="perspective-1000 my-4 relative h-[180px] w-full">
        ...
        <div 
          className="absolute top-4 left-4 right-4 bottom-4 rounded-2xl transform-gpu rotate-[-8deg] z-10 dark:opacity-80"
          style={{ 
        ...
        <div 
          className="absolute top-2 left-2 right-2 bottom-2 rounded-2xl transform-gpu rotate-[-4deg] z-20 dark:opacity-90"
          style={{ 
      ...
      <a
        ...
        className="block w-full text-center py-3 px-4 rounded-full text-gray-700 dark:text-white bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm font-medium hover:shadow-md transition-all duration-300 flex items-center justify-center"
