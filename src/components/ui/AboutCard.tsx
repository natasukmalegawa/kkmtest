...
export function AboutCard({ title, description, icon, iconBgColor = 'bg-blue-500' }: AboutCardProps) {
  return (
    <div className="group h-[250px] w-full mb-8 perspective-1000">
      {/* Card container with padding to accommodate the transform */}
      <div className="bg-white/70 dark:bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-lg 
                     transition-all duration-300 transform group-hover:-translate-y-2 
                     border border-white/20 h-[220px] w-full relative
