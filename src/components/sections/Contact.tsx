  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-32 h-32 rounded-full bg-blue-300/30 dark:bg-blue-500/20 filter blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/4 w-40 h-40 rounded-full bg-purple-300/20 dark:bg-purple-500/15 filter blur-3xl"></div>
        <div className="absolute top-2/3 left-1/3 w-36 h-36 rounded-full bg-pink-300/20 dark:bg-pink-500/15 filter blur-3xl"></div>
      </div>
