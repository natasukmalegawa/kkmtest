    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-16">
          {smallTitle && (
            <p className="text-purple-400 text-sm font-medium mb-2 tracking-wide uppercase sf-pro-text">
              {smallTitle}
            </p>
          )}
          <h2 className="text-3xl md:text-4xl font-semibold mb-4 sf-pro-display text-white">
            {title}
          </h2>
          <p className="text-gray-300 text-lg max-w-2xl mx-auto sf-pro-text">
            {subtitle}
          </p>
        </div>
        ...
        <div className="max-w-lg mx-auto">
          {card ? (
            ...
            <div className="animate-pulse rounded-3xl h-[300px] bg-gray-800"></div>
          )}
        </div>
      </div>
